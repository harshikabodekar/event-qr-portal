                ...
                editingId === student.id ? (
                  <tr key={student.id} className="bg-blue-50 dark:bg-gray-900">
                    <td className="px-2 py-1">
                      <input name="name" value={editForm.name} onChange={handleEditChange} className="rounded px-2 py-1 border" />
                    </td>
                    <td className="px-2 py-1">
                      <input name="email" value={editForm.email} onChange={handleEditChange} className="rounded px-2 py-1 border" />
                    </td>
                    <td className="px-2 py-1">
                      <input name="phone" value={editForm.phone} onChange={handleEditChange} className="rounded px-2 py-1 border" />
                    </td>
                    <td className="px-2 py-1">
                      <input name="college" value={editForm.college} onChange={handleEditChange} className="rounded px-2 py-1 border" />
                    </td>
                    <td className="px-2 py-1">
                      <input name="department" value={editForm.department} onChange={handleEditChange} className="rounded px-2 py-1 border" />
                    </td>
