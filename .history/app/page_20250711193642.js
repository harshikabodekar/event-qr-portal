        ...
        <div className="mt-16">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
              ...
              <p className="mt-2 text-gray-600">Quick and easy registration process with automatic QR code generation.</p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
              ...
              <p className="mt-2 text-gray-600">Fast check-in process using QR code scanning technology.</p>
