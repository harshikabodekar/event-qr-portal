...
export default function CheckinPage() {
  ...
  const onScanSuccess = async (decodedText) => {
    ...
    try {
      ...
      // Update check-in with timestamp
      try {
        await supabase
          .from('students')
        ...
        setStatus(`🎉 ${student.name} check-in recorded (locally)!`);
        toast.success(`${student.name} check-in recorded!`);
      }
  ...
  // Handle success modal close and continue scanning
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex flex-col items-center justify-center min-h-screen p-8">
        ...
        {/* Success Modal */}
        {showSuccessModal && checkedInStudent && (
          <Modal onClose={() => setShowSuccessModal(false)}>
            <div className="p-4">
              <h2 className="text-lg font-bold mb-2">Check-in Successful!</h2>
              <p className="mb-4">
                {checkedInStudent.name} has been checked in successfully.
              </p>
              <button
