    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-100">
        ...
        <div className="flex flex-col items-center justify-center min-h-screen p-8">
          <Toaster />
          <div className="bg-white/80 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-purple-100 w-full max-w-md">
            <h2 className="text-2xl font-bold text-center bg-gradient-to-r from-purple-600 to-purple-800 bg-clip-text text-transparent mb-6">🔐 Organizer Login</h2>
            <form onSubmit={handleLogin} className="space-y-4">
              <input 
                ...
                className="w-full px-4 py-3 border border-purple-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-black bg-purple-50/30" 
                required 
              />
              <button type="submit" className="w-full bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white rounded-lg px-4 py-3 font-semibold transition-all duration-300 shadow-md hover:shadow-lg">
                🚀 Login
              </button>
            </form>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-100">
      ...
      <Modal open={editModalOpen} onClose={() => setEditModalOpen(false)}>
        <div className="p-6">
          <h3 className="text-xl font-bold mb-4 text-black">Edit Student Information</h3>
          <form onSubmit={handleEditSubmit} className="flex flex-col gap-4">
            <div>
              ...
              <input 
                ...
                className="w-full rounded-lg px-3 py-2 border border-gray-300 text-black focus:outline-none focus:ring-2 focus:ring-blue-500" 
                required 
              />
            </div>
            <div>
            ...
            <div className="flex gap-3 mt-4">
              <button 
                type="submit" 
                disabled={loading} 
                className="flex-1 bg-green-600 text-white rounded-lg px-4 py-3 hover:bg-green-700 transition-colors font-semibold disabled:opacity-60"
              >
              ...
              <button 
                ...
                className="flex-1 bg-gray-500 text-white rounded-lg px-4 py-3 hover:bg-gray-600 transition-colors font-semibold"
              >
                Cancel
              </button>
            </div>
